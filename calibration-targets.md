...
MAPIR oferuje różne cele kalibracyjne, które mogą być wykorzystywane w wielu zastosowaniach. Kompaktowy model T4-R50, przedstawiony poniżej, zawiera 4 panele, które zostały zmierzone pod kątem odbicia światła w zakresie od 250 do 2500 nm.
...
Patrząc na wykres odbicia, można zauważyć, że wartości są długością fali (oś x) w stosunku do procentowego odbicia (oś y). Kiedy robimy zdjęcie wzorca kalibracyjnego, tworzymy relację między wartością pikseli a procentowym odbiciem w zakresie widma, na które wrażliwe są pasma czujnika aparatu.
