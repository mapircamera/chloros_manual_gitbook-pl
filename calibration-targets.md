---
description: Panele mierzone laboratoryjnie, używane do kalibracji danych przechwyconych podczas przetwarzania końcowego
metaLinks:
  alternates:
...
MAPIR oferuje różne cele kalibracyjne do różnych zastosowań. Kompaktowy model T4-R50, widoczny poniżej, zawiera 4 panele, które zostały zmierzone pod kątem odbicia światła w zakresie od 250 do 2500 nm.
...
Patrząc na wykres odbicia, można zauważyć, że wartości są długością fali (oś x) w stosunku do procentowego odbicia (oś y). Kiedy robimy zdjęcie celu kalibracyjnego, tworzymy związek między wartością pikseli a procentowym odbiciem w zakresie widma, na które wrażliwe są pasma czujnika aparatu.
